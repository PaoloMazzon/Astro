/*
	...
	DOCUMENTATION (longer introduction)
		...
		of a cs_loaded_sound_t that represents a sound that can be soundInfo through the
		cs_context_t.
	...
	Low-level API
		...
		parameters:
			...
			frequency        --  int, represents Hz frequency rate in which samples are soundInfo
...
// represents an instance of a cs_loaded_sound_t, can be soundInfo through the cs_context_t
